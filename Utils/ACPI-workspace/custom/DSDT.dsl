 ...
 *
 * Disassembly of DSDT.aml, Thu Aug 29 12:41:45 2019
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000154A1 (87201)
 *     Revision         0x02
 *     Checksum         0xA8
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "CB-01   ", 0x00000001)
{
     ...
     * disassembly, but only 10 were resolved (10 unresolved). Additional
    ...
    Name (SS3, One)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x8B250698, 0x0635)
    ...
    OperationRegion (OGNS, SystemMemory, 0x8B24FF98, 0x0000000E)
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        Name (PLDP, Package (0x01)
                        {
                            Buffer (0x10)
                            {
                                ...
                                /* 0008 */  0x90, 0x0C, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00 
                            }
                        })
                        Return (PLDP)
                    }
                ...
                Device (HS02)
                {
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        Name (PLDP, Package (0x01)
                        {
                            ...
                            {
                                /* 0000 */  0x82, 0xC6, 0x72, 0x00, 0x00, 0x00, 0x00, 0x00,
                                /* 0008 */  0x99, 0x0C, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 
                            }
                        })
                        Return (PLDP)
                    }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        Name (PLDP, Package (0x01)
                        {
                            Buffer (0x14)
                            {
                                ...
                                /* 0008 */  0x99, 0x0C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                ...
                Device (HS04)
                {
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        Name (PLDP, Package (0x01)
                        {
                            ...
                            {
                                /* 0000 */  0x82, 0xC6, 0x72, 0x00, 0x00, 0x00, 0x00, 0x00,
                                /* 0008 */  0x99, 0x0C, 0x80, 0x01, 0x00, 0x00, 0x00, 0x00 
                            }
                        })
                        Return (PLDP)
                    }
    ...
    Scope (_SB.PCI0)
    {
        ...
        Device (GPI0)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateDWordField (RBUF, \_SB.PCI0.GPI0._CRS._Y17._INT, IRQN)  // _INT: Interrupts
                Store (Add (SBRG, 0x00AF0000), COM0)
                Store (Add (SBRG, 0x00AE0000), COM1)
                CreateDWordField (RBUF, \_SB.PCI0.GPI0._CRS._Y18._BAS, COM3)  // _BAS: Base Address
    ...
    IRQNoFlags() { 0, 8, 11, 15 }
        ...
        Device (MSS0)
        {
            Method (_HID, 0, Serialized)  // _HID: Hardware ID
            {
                ...
                ElseIf (LEqual (TPDF, One))
                {
                    Return (0x4216A906)
                }
                ElseIf (LEqual (TPDF, 0x04))
                {
                    Return (0x642B2E4F)
                }
                ElseIf (LEqual (TPDF, 0x05))
                {
                    Return (0x662B2E4F)
                }
                ElseIf (LEqual (TPDF, 0x06))
                {
                    Return (0x652B2E4F)
                }
                ElseIf (LEqual (TPDF, 0x08))
                {
                    Return (0x51068416)
                }
                ElseIf (LEqual (TPDF, 0x09))
                {
                    Return (0x53068416)
                }
                ElseIf (LEqual (TPDF, 0x10))
                {
                    Return (0x4416A906)
                }
                ElseIf (LEqual (TPDF, 0x14))
                {
                    Return (0x672B2E4F)
                }
                ElseIf (LEqual (TPDF, 0x18))
                {
                    Return (0x53068416)
                }
                Else
...
P8XH (One, 0xAB)
        ...
        ElseIf(LOr(_OSI("Darwin"),_OSI("Windows 2009")))
        {
        ...
        If (LOr (LEqual (Arg0, 0x03), LEqual (Arg0, 0x04)))
        {
            If (LOr (LNotEqual (RXMS (0x54), Zero), LEqual (\_SB.PCI0.LPCB.EC0.WOLS, One))){}
            Else
            {
                Notify (\_SB.PWRB, 0x02)
            }

            Store (Zero, \_SB.PCI0.LPCB.EC0.RWAK)
            If (And (GBSX, 0x40))
            {
        ...
        Scope (_SB.PCI0.XHC)
        {
            Device (ICAM)
            {
                ...
                Method (_STA, 0, Serialized)  // _STA: Status
                {
                    ...
                    If (LEqual (GGIV (0x02020009), Zero))
                    {
                        Return (Zero)
                    }
    ...
    OperationRegion (LGNS, SystemMemory, 0x8B239000, 0x00000005)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        ...
        Device (EC0)
        {
            ...
            {
                Name (ESRC, 0x05)
                If (LEqual (DerefOf (Index (Arg0, Zero)), 0x15))
                {
                    CreateWordField (Arg1, Zero, SFUN)
                    If (LEqual (SFUN, 0x9001)){}
                    ElseIf (LEqual (SFUN, 0x9002))
                    {
                        Store (Zero, STDT)
                        Store (Zero, BFDT)
                        Store (Zero, BFDT)
                ...
                ElseIf (LNotEqual (Match (CTSL, MEQ, DerefOf (Index (Arg0, Zero)), MTR, Zero, Zero), Ones))
                {
                    Acquire (CFMX, 0xFFFF)
                    Store (Arg0, SMID)
                    Store (Arg1, SFNO)
            ...
            Method (CMFC, 4, Serialized)
            {
                ...
                ElseIf (LLess (DerefOf (Index (Arg0, Zero)), 0xFF))
                {
                    Store (Buffer (0x82){}, Local1)
                    CreateWordField (Local1, Zero, RTST)
                    CreateField (Local1, 0x10, 0x0400, RTDT)
                    If (LAnd (LLessEqual (ToInteger (Arg0), 0x8F), LGreaterEqual (ToInteger (Arg0), 0x80)))
                    {
    ...
    Scope (_SB.PCI0.LPCB.EC0)
    {
        ...
        Device (VPC0)
        {
            ...
            Method (_CFG, 0, NotSerialized)
            {
                If (LEqual (CATO, Zero))
                {
                    CopyObject (\_PR.CPU0._PSS, Local4)
                    Store (SizeOf (Local4), Local0)
                    Store (DerefOf (Index (Local4, One)), Local1)
                    ...
                    {
                        Store (DerefOf (Index (Local4, Local2)), Local3)
